...
items
	...
	secondary_items
		...
		molotov
			...
			ammount = 1
			maxammount = 3
			projectile = /obj/projectiles/molotov
		grenade
			chance = 80
			name = "Grenade"
			icon_state = "grenade"
			ammount = 1
			maxammount = 6
			projectile = /obj/projectiles/grenade
		mine
			chance = 60
			name = "Mine"
			icon_state = "mine"
	...
	weapons
		...
		shotgun
			...
			projectile = /obj/projectiles/shotgun_blast
			blois = "emptyshell"
			New()
				..()
		...
		pistol
			...
			projectile = /obj/projectiles/pistol_bullet
			blois = "emptybullet"
			New()
				..()
		...
		crossbow
			...
			projectile = /obj/projectiles/bolt
			blois = null
			New()
				..()
		...
		rifle
			...
			projectile = /obj/projectiles/rifle_bullet
			blois = "emptybullet"
			New()
				..()
				src.fire_sound = SOUND_GUNFIRE1
		burst_rifle
			...
			projectile = /obj/projectiles/burst_bullet
			blois = "emptybullet"
			New()
				..()
				src.fire_sound = SOUND_GUNFIRE1
		magnum
			...
			projectile = /obj/projectiles/magnum_bullet
			blois = "emptybullet"
			New()
				..()
				src.fire_sound = SOUND_GUNFIRE1
		flamethrower
			...
			projectile = /obj/projectiles/flamethrower_bullet
			blois = null
			New()
				..()
				src.fire_sound = null
		auto_shotgun
			...
			projectile = /obj/projectiles/autoshotgun_blast
			blois = "emptyshell"
			New()
				..()
				src.fire_sound = SOUND_SHOTGUN
		grenade_launcher
			...
			projectile = /obj/projectiles/launch_grenade
			blois = "emptyshell"
			New()
				..()
				src.fire_sound = SOUND_SHOTGUN
