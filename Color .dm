mob/player/client/var/tmp/color = null

var/list/colors = list("Blue" = "#1C86EE", "Red" = "#FF3333", "Green" = "#00FF00", "Purple" = "#FF00FF", "Orange" = "#FFB90F")
var/list/color_check = new/list()

proc
	color_gen_checker()
		for(var/C in colors) color_check += colors[C]
	hex2rgb(hex)
